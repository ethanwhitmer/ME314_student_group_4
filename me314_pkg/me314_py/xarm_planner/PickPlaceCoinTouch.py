        ...
        if self.state == INITIALIZATION:
            ...
            if Event == ES_COMMAND_EXECUTED:
                ...
                if self.aboveItem:
                    ...
                    wrapper_above.pose_command.x = self.ItemPoint[0]
                    wrapper_above.pose_command.y = self.ItemPoint[1] - 0.008
                    wrapper_above.pose_command.z = 0.1 # Change this accordingly!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                    ...
                    wrapper_down.pose_command.y = self.ItemPoint[1] - 0.008
                    wrapper_down.pose_command.z = 0.021 # Change this accordingly!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            if Event == ES_TIMEOUT:
                ...
                wrapper_shift_up.pose_command.y = self.ItemPoint[1] - 0.008
                wrapper_shift_up.pose_command.z = self.ground - 0.018    # +0.009
                ...
                wrapper_square.pose_command.z = self.ground + 0.035 # 0.03
